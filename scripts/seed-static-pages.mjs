...
const PAGES = [
  // ─────────────────────────────── AIDE
  {
    ...
    body: [
      ...
      h2("Après-vente"),
      faq("Quelle est la durée de garantie ?", "De 2 à 8 ans selon les produits : 2 ans minimum sur les matelas, 5 ans sur les sommiers, 5 ans structure et 8 ans vérins sur les lits coffre. La garantie exacte figure sur chaque fiche produit."),
  ...
  },
  {
    ...
    slug: "garantie",
    title: "Garantie",
    excerpt: "De 2 à 8 ans selon les produits. Ce qui est couvert, ce qui ne l'est pas, et comment faire jouer la garantie.",
    ...
    body: [
      ...
      ...ul([
        "Matelas : 2 ans minimum, davantage selon les modèles — la durée exacte figure sur chaque fiche produit.",
        "Sommiers : 5 ans sur la structure.",
        "Lits coffre : 5 ans sur la structure, 8 ans sur les vérins, 2 ans sur le tissu.",
        "Oreillers et linge de lit : 2 ans.",
      ]),
