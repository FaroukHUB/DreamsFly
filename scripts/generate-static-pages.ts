...
const cgv = {
  ...
  body: [
    ...
    p("La livraison s'effectue à l'adresse indiquée lors de la commande, en France métropolitaine. Frais de port forfaitaires de 99 € par commande. Délais indicatifs : 3 à 5 jours ouvrés. Les délais ne constituent pas un engagement ferme et ne peuvent ouvrir droit à indemnités."),
...
const livraison = {
  ...
  metaDescription: "Livraison DreamsFly partout en France métropolitaine, forfait 99 €. Délais 3-5 jours ouvrés. Suivi en temps réel et options spéciales (étage, déballage).",
  body: [
    h2("Où livrons-nous ?"),
    ...
    h2("Tarifs"),
    p("• France métropolitaine : forfait unique 99 € par commande"),
...
const faqPage = {
  ...
  body: [
    ...
    h2("Livraison"),
    faq("Combien coûte la livraison ?", "Forfait unique de 99 € par commande, en France métropolitaine, quel que soit le poids ou le nombre d'articles. Options express (+29 €), étage (+49 €), reprise ancien matelas (+29 €) disponibles."),
