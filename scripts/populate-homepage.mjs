...
const TESTIMONIALS = {
  ...
  totalReviews: 1167,
  items: [
    { _key: k(), name: "Sophie L.", location: "Lyon", rating: 5, text: "Livraison rapide, matelas parfait, essai 30 nuits qui a rassuré. Je recommande vraiment.", productBought: "Matelas MILAN 160×200", date: "2026-05-22" },
    { _key: k(), name: "Marc T.", location: "Bordeaux", rating: 5, text: "Le service client a répondu à mes questions en 30 min. Rare de nos jours. Bravo.", productBought: "Lit ATHÈNE 140×190", date: "2026-04-18" },
    { _key: k(), name: "Claire P.", location: "Paris", rating: 5, text: "J'avais peur d'acheter un matelas en ligne. Résultat : meilleur sommeil depuis 5 ans.", productBought: "Matelas BERLIN 140×190", date: "2026-05-30" },
    { _key: k(), name: "Julien R.", location: "Nantes", rating: 5, text: "Le lit coffre nous change la vie dans notre 45m². Vérins impeccables même après 6 mois.", productBought: "Lit COCO 160×200", date: "2026-03-12" },
    { _key: k(), name: "Amélie D.", location: "Toulouse", rating: 4, text: "Excellent produit, seul bémol : livraison à 8 jours au lieu de 5 annoncés. Mais parfaitement emballé et livreurs très pros.", productBought: "Sommier DreamsFly", date: "2026-06-02" },
    { _key: k(), name: "Nicolas B.", location: "Marseille", rating: 5, text: "Testé en showroom avant commande, décision facile. Le conseiller connaissait vraiment son sujet.", productBought: "Matelas LONDRES 180×200", date: "2026-04-05" },
  ],
};
