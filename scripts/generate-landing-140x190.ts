    ...
    // 11. FAQ
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            "Oui. DreamsFly livre dans toute la France métropolitaine avec un forfait unique affiché au panier. Délai : 3 à 5 jours ouvrés selon la zone. Pour un retrait gratuit en entrepôt, contactez-nous.",
        },
        {
          _key: "f7",
