  ...
  switch (productType) {
    case "matelas":
      return [
        ...
        { question: "Comment se déroule la livraison ?", answer: "Livraison sous 5-7 jours ouvrés en France métropolitaine, gratuite dès 39 €. Rendez-vous par SMS 48h avant, montée à l'étage incluse, reprise gratuite de l'ancien matelas sur demande." },
    ...
    case "sommier":
      return [
        ...
        { question: "Combien de temps pour la livraison ?", answer: "5-7 jours ouvrés en France métropolitaine, gratuite dès 39 €. Rendez-vous par SMS 48h avant, montée à l'étage incluse." },
      ];
    case "oreiller":
      return [
